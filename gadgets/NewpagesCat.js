...
var _addText = '{{Documentation|content=在[[Special:最新页面]]中查询新条目里面属于某分类或其子分类的数量。}}';
...
$(() => (async () => {
    if (mw.config.get("wgCanonicalSpecialPageName") === "Newpages") {
        ...
        // 构建表单
        $("head").append(`<style>
            #new-page-in-cat .npic-flex .oo-ui-fieldLayout-body {
                display: flex;
            }
            #new-page-in-cat .npic-flex .oo-ui-fieldLayout-header {
                flex: 0 0 5em;
                margin-right: 0;
            }
            #new-page-in-cat .npic-flex .oo-ui-fieldLayout-field {
                flex: 1 1 12em;
                max-width: 28em;
            }
            #new-page-in-cat .oo-ui-buttonWidget {
                margin: .5em 0;
            }
        </style>`);
