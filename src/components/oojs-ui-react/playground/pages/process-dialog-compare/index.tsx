...
function OriginalProcessDialog() {
  ...
  useEffect(() => {
    ...
    ensureOOUI().then((OO) => {
      ...
      DemoDialog.prototype.getBodyHeight = function () {
        return 120;
      };
      ...
      containerRef.current.appendChild(unwrapJQuery(windowManager.$element));
      host.add(windowManager);
      ...
      containerRef.current.prepend(openButton);
      setStatus('原版已就绪');
...
function ProcessDialogComparePage() {
  return (
    <>
      <h1>ProcessDialog/ProgressBar 对照 - 原版oojs-ui vs oojs-ui-react</h1>
      <p>
