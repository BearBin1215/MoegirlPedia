/**
 * @abstract 添加清除缓存按钮。
 * @description 改自[[MediaWiki:Gadget-Purgecache.js]]，相比原工具去掉了后面的时间，并在moeskin下进行了样式的适配。
 * @junk 刚学js，只知道用一个函数包裹起来，别的毛都不会，期待改进。
 */
...
$(function () {
	...
	if (mw.config.get('wgNamespaceNumber') != -1) {
		...
		var containerNode1 = purgeCache()
		var containerNode2 = purgeCache()
		li.append(containerNode1);
